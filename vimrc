...
if !empty(glob("~/.vim/bundle/Vundle.vim"))
  ...
  Plugin 'git://git.schuerz.at/Vim/Vundle.vim.git'
  Plugin 'git://git.schuerz.at/Vim/Zenburn.git'
  Plugin 'git://git.schuerz.at/Vim/vim-colors-solarized.git'
  Plugin 'git://git.schuerz.at/Vim/indentpython.vim.git'
  ...
  Plugin 'git://git.schuerz.at/Vim/vim-bracketed-paste.git'
